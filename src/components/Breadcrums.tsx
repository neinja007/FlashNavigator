			...
			{['', ...groups].slice(Math.max(groups.length - 2, 0)).map((group, i) => (
				<Fragment key={i}>
					<button
						...
						className='mx-2 max-w-[150px] truncate rounded-lg border border-blue-800 bg-blue-950 px-2 py-1 text-white shadow-md shadow-blue-600 transition-all hover:shadow-sky-300 active:bg-blue-900'
					>
